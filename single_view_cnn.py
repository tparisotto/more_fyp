...
def generate_cnn(app="vgg"):
    ...
    x_class = keras.layers.Dense(4096, activation='relu')(x)
    x_view = keras.layers.Dense(4096, activation='relu')(x)
    x_class = keras.layers.Dropout(0.5)(x_class)
    x_view = keras.layers.Dropout(0.5)(x_view)
    x_class = keras.layers.Dense(220, activation='relu')(x_class)
    x_view = keras.layers.Dense(220, activation='relu')(x_view)
    ...
    model.compile(keras.optimizers.Adam(), loss=losses, metrics=METRICS)
